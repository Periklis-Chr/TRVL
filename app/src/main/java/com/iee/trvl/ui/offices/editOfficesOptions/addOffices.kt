 ...
 * Use the [addOffices.newInstance] factory method to
...
class addOffices : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment addOffices.
         */
        // TODO: Rename and change types and number of parameters
        fun newInstance(param1: String?, param2: String?): addOffices {
            val fragment = addOffices()
            val args = Bundle()
